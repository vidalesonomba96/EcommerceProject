...
// Security Check: Fetch the product ONLY if it belongs to the current user
$stmt = $conn->prepare("SELECT id, name, description, price, category, image_path FROM products WHERE id = ? AND user_id = ?");
...
if (!$product) {
    // If no product is found, it either doesn't exist or doesn't belong to the user.
...
<head>
    ...
    <!-- Correctly linking to the main stylesheet -->
...
<body class="auth-page">
    ...
    <main class="site-main auth-page">
        <section class="auth-section">
            <div class="container">
                <!-- Using the same auth form container as upload_product.php for consistent styling -->
                <div class="auth-form-container upload-form-container">
                    <h1 class="section-title auth-title">Edit Your Product</h1>
                    
                    <form action="update_my_product_handler.php" method="POST" enctype="multipart/form-data" class="auth-form">
