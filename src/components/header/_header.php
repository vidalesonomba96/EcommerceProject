...
// --- START: Cart Badge Initialization ---
        ...
        <nav class="nav-desktop">
           ...
           <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
            ...
            <a href="<?php echo htmlspecialchars($base_url); ?>/src/pages/cart.php" class="nav-link cart-link"> <i class="fas fa-shopping-cart"></i>
                <span class="cart-badge" style="<?php echo ($cart_item_count_for_badge > 0) ? 'display: flex;' : 'display: none;'; ?>"><?php echo $cart_item_count_for_badge; ?></span>
            </a>
        </nav>
