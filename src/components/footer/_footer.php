...
<footer class="site-footer">
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-links-column">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">FAQ</a></li> 
            ...
            <div class="footer-links-column">
                ...
                <ul>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>">Buyer Guide</a></li>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">Safety Tips</a></li>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">Report an Issue</a></li>
                </ul>
            </div>
            <div class="footer-links-column">
                <h4 class="footer-heading">For Sellers</h4>
                <ul>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">Seller Guide</a></li>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">Fees &amp; Pricing</a></li>
                    <li><a href="<?php echo htmlspecialchars($base_url); ?>/">Seller Dashboard</a></li>
                </ul>
            </div>
        </div>
        <div class="footer-bottom">
            ...
            <p>
                <a href="<?php echo htmlspecialchars($base_url); ?>/">Privacy Policy</a> |
